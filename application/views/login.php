...
<div class="blok_header">
    <div class="header">
      ...
      <!--img src="<!--?php echo base_url();?>asset/images/logo.png" width="85" height="71" border="0" alt="logo" /--></a>
	        </div>
      <div class="judul">
      <h1>Selamat Datang Di Inventory Gudang<!--?php ech$instansio ;?--></h1><br>
     <center> <h1> LEGEND COFFEE</h1></center><!--?php echo $alamat_instansi;?-->
      </div>
      <div class="clr"></div>
	</div>
    <div class="clr"></div>
    <div class="header_text_bg">
    	<div class="clr"></div>
        <div id="header">
        <h1> <img src="<?php echo base_url();?>asset/images/logo.png" width="250" height="200" border="0" alt="logo" /><h1>
        <h3></h3>
        </div> 
	</div>       
</div>              
...
<div id="footer" align="center">
	<p>Copyright &copy; <?php echo $instansi;?> 2016</p>
