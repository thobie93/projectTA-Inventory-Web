<div title="Master" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
    ...
    <a href="<?php echo base_url();?>index.php/barang">Barang Gudang</a>
    </li>
...
<div title="Transaksi" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
    ...
    <ul class="easyui-tree">
    <li data-options="iconCls:'icon-surat_keputusan'">
    <a href="<?php echo base_url();?>index.php/pembelian">Barang Masuk</a>
    </li>
    <li data-options="iconCls:'icon-surat_keluar'">
    <a href="<?php echo base_url();?>index.php/penjualan">Barang Keluar</a>
    </li>
    </ul>
    </div>
</div>
<div title="Laporan" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
    ...
    <li>
    <span><a href="<?php echo base_url();?>index.php/lap_beli">Barang Masuk</a></span>
    </li>
    <li>
    <span><a href="<?php echo base_url();?>index.php/lap_jual">Barang Keluar</a></span>
    </li>
    <li>
    <span><a href="<?php echo base_url();?>index.php/profit">estimasi Profit</a></span>
    </li>
    </ul>
    </div>
</div>
<div title="Grafik" data-options="iconCls:'icon-grafik'" style="overflow:auto;padding:5px 0px;">
    ...
    <ul class="easyui-tree">
    <li>
    <span><a href="<?php echo base_url();?>index.php/grafik_beli">Barang Masuk</a></span>
    </li>
    <li>
    <span><a href="<?php echo base_url();?>index.php/grafik_jual">Barang Keluar</a></span>
    </li>
